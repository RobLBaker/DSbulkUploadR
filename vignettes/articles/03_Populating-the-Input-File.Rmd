...
For a full list of reference types and the appropriate way to specify them, see the [DataStore swagger documentation for the appropriate API](https://irmaservices.nps.gov/datastore/v8/documentation/datastore-api.html#/Lookup%20Lists/FixedList_GetReferenceTypes)
...
### Date published
Only for Reports. This is the date that the Report was originally published. Leave blank if unpublished.

## Publisher
Only for Reports. In the case of many reports that are "by or for NPS" the publisher is likely "National Park Service". 
