...
`make_input_template()` creates a DataStore reference-specific template input.txt file. After you populate the input.txt file, a second function `bulk_reference_generation()` takes the data in the input.txt file and uses it to perform the bulk upload. The bulk upload consists of:
