...
After creating the references, may wish to (after appropriate review, if requried) activate the references. You use the reference IDs within the dataframe returned by `generate_references` as the input for the `activate_references` function.
