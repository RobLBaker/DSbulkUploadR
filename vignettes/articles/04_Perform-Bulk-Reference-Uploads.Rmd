...
# Overview
Once you have finished filling out your input.txt file, you are ready to create references on DataStore! It can be quite easy to make hundreds or even thousands of references so if this is the first time you have used this package please consider testing a subset of your input.txt file using the development server.
...
You may want to check the object `dev_refs` to see a list of the newly created reference numbers, which has been added to the information you supplied in your `truncated_input.txt` file.
